...
function insertar (foliorpm, fecha, nombre, email, movil, tel, rsocial, rfc,
    ...
    mysql.query(`Insert into proveedores (foliorpm, fecha, nombre, email, movil, tel, rsocial, rfc,rfiscal, cfdi, fpago, calle, next, colonia, ninten, municipio, ciudad, cpostal, cnombre, cemail, cmovil, ctel, beneficiario, nombanco, clabe, cuenta, refpago, credito, cdias) 
